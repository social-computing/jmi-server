 ...
 * @version 1.0
 */
JMI.namespace("com.socialcomputing.jmi.script.ShapeX") = (function() {
	...
	Constr.prototype = {
		constructor: com.socialcomputing.jmi.script.ShapeX,
		version: "2.0"
	}
	return Constr;
}());
 ...
 */
com.socialcomputing.jmi.script.ShapeX.POLYGON_VAL = 1;
 ...
 */
com.socialcomputing.jmi.script.ShapeX.SCALE_VAL = 2;

/*
 * True if this Shape is a link between exactly its 2 points.
 * This is now useless because it's always true.
 */
com.socialcomputing.jmi.script.ShapeX.CTR_LNK_BIT = 0x001;
 ...
 */
com.socialcomputing.jmi.script.ShapeX.SEC_LNK_BIT = 0x002;

/*
 * True if this Shape is a link AND its anchor points are tangent to the places.
 * This is useless because the links are drawn under the place now.
 */
com.socialcomputing.jmi.script.ShapeX.TAN_LNK_BIT = 0x004;
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.transformOut = function( zone, transfo) {
    if ( isDefined( SCALE_VAL ))    // else it is just a void frame
    {
        ...
        return new com.socialcomputing.jmi.script.Point(x, y);
    }
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.getCenter = function(zone) {
    var points = getValue(POLYGON_VAL, zone.m_props);
    var p ;
    var c = new com.socialcomputing.jmi.script.Point(points[0].x,  points[0].y);
    var i ;
    var n = points.length;
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.contains = function(g, zone, transfo, center, pos) {
    if(!isDefined(SCALE_VAL)) return false; // it is just a void frame
    
    var points = getValue(POLYGON_VAL, zone.m_props);
    var shapeCenter = this.getCenter(zone);
    var shapePosition = new com.socialcomputing.jmi.script.Point(0,0);
    ...
    switch(nbPoint) {
        ...
        case 1: 
            var distance = new com.socialcomputing.jmi.script.Point( shapeCenter.x, shapeCenter.y);
        ...
        case 2:     
            var fromPoint = new com.socialcomputing.jmi.script.Point( points[0].x, points[0].y);
            fromPoint.add(shapePosition);
            var toPoint = new com.socialcomputing.jmi.script.Point( points[1].x, points[1].y);
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.setBounds = function(g , zone , transfo , center, bounds ) {
    ...
    if (isDefined(SCALE_VAL)) {
        ...
        switch (n) {
            ...
            // 2 points = segment => Street
            case 2:     
                var A = new com.socialcomputing.jmi.script.Point( points[0].x, points[0].y);
                A.add(shapePos);
                var B = new com.socialcomputing.jmi.script.Point( points[1].x, points[1].y);
                B.add(shapePos);
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.getLinkPoly = function( zone, A, B, width) {
    ...
    var N = new com.socialcomputing.jmi.script.Point( B.x - A.x, B.y - A.y );
...
com.socialcomputing.jmi.script.ShapeX.prototype.addLinkPoint = function( poly, u, v, center, U, V) {
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.drawImage = function(applet, s, zone, imageNam, transfo, center) {
	// Else it is just a void frame
	if (isDefined(SCALE_VAL)) {
		var image;//:Bitmap;
		var imageUrl;//:String;
...
com.socialcomputing.jmi.script.ShapeX.prototype.drawLoadedImage = function(applet , image, s, zone, imageNam, transfo, center, render) {
	...
	var shapePos:Point = new com.socialcomputing.jmi.script.Point(0, 0);
 ...
 */
com.socialcomputing.jmi.script.ShapeX.prototype.getShapePos = function(zone, transfo, center, p0, pos) {
    var scale = getFloat(SCALE_VAL, zone.m_props);
    
    var p = com.socialcomputing.jmi.script.Point;
 ...
 */
com.socialcomputing.jmi.script.ShapeX.pivotPnt = function( P) {
    P.x  -= P.y;
    P.y  += P.x;
    P.x  -= P.y;
}
