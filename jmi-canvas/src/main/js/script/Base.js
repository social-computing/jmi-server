	...
	Base.prototype = {
		...
		*/
		...
		parseString3 : function(text, props) {
			// Bug fix : javascript
			var javascript = text.substring(0, 10) === "javascript", tokens = JMI.script.Base.parseTokens(text), i, j, n, max = 0;
...
JMI.script.Base.parseString4 = function(text, props, isHtm) {
	var tokens = JMI.script.Base.parseTokens(text), token, i, j, n, max = 0;
