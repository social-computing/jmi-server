 ...
 * @version 1.0
 */
JMI.namespace("com.socialcomputing.jmi.script.Plan") = (function() {
/*
 ...
 */
	m_curSat = com.socialcomputing.jmi.script.Satellite,

/**
 * Bounding box of the Plan before resizing (pixels).
 */
	m_prevBox = com.socialcomputing.jmi.script.Rectangle,

/**
 * Maximum bounding box of all zones. This is also the m_blitBuf size.
 */
	m_maxBox = com.socialcomputing.jmi.script.Dimension,
 ...
 */
	m_curZone = com.socialcomputing.jmi.script.ActiveZone,

/**
 * Current ActiveZone (the one that is active). This can be a subZone, different from m_curZone.
 * If there is no current ActiveZone, it should be null.
 */
	m_newZone = com.socialcomputing.jmi.script.ActiveZone,

/**
 * The Applet holding this Plan.
 */
	m_applet = com.socialcomputing.jmi.component.Map,
 ...
 */
	...
	Constr.prototype = {
		constructor: com.socialcomputing.jmi.script.Plan,
		version: "2.0"
	}
	return Constr;
}());
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.initZones = function(s, zones, isFirst) {
    var i,
		n = zones.length,
    	dim = m_applet.size;
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.paintZones = function( s, zones, n, isFront, showTyp, showLinks, isRev) {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.init = function() {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.updateZoneAt = function(p) {
 ...
 * @return			True if the current satellite has changed.
 */
com.socialcomputing.jmi.script.Plan.prototype.updateCurrentZone = function( curSat, p) {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.paintCurZone = function() {
	// A new Zone is hovered, let's paint it!
	if (m_curZone != null) {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.popSlice = function( zone, slice, delay, length, key) {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.resize = function(dim) {
    if (m_prevBox != null
			...
			&& dim.width > 100 && dim.height > 100 )
    {
        ...
        var dy; //:Number;
        var s; //:Number;
        var zone = com.socialcomputing.jmi.script.ActiveZone;
        ...
        m_prevBox = new com.socialcomputing.jmi.script.Rectangle(0, 0, dim.height, dim.width);
    }
}
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.resizePoint = function(zone, i, dx, dy, sx, sy) {
 ...
 */
com.socialcomputing.jmi.script.Plan.prototype.blitImage = function (g, shape, bounds) {
    var dim = m_applet.size;
