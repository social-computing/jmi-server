...
public class StringToNumConverter
{
   ...
   protected HashMap m_StringToNum=null;
...
long t2= System.currentTimeMillis();
 ...
 for (int i=0; i<size; ++i)
	  {
//      System.out.println(i+":"+conv.getNum((new Integer(i)).toString()));
	  conv.getNum(temp[i]);
	  }
...
System.out.println("Contains:"+temp[200]+":"+conv.contains(temp[200]));
System.out.println("Contains:"+"NotInMap:"+conv.contains("NotInMap"));
}
...
/**
  *  */
   ...
   {
   Integer value=(Integer)m_StringToNum.get(id);
...
/**
  * */
   public  StringToNumConverter( Collection stringList )
   {
   m_NumToString=new String[stringList.size()];
   m_StringToNum=new HashMap();
...
/**
  ...
  *  */
   ...
   System.arraycopy(m_NumToString/*src*/, 0,  newArray/*dest*/, 0, m_NumToString.length);
